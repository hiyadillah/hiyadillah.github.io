      ...
      <div id="inter" className="container flex flex-col lg:flex-row bg-gray-200 h-screen w-screen text-black ">
        ...
        <div className="hidden xl:flex flex-col items-center justify-center w-full h-full">
          <div id="ppbox" className="border-4 -mt-26 rounded-full bg-gradient-to-r from-[#6EE7B7] via-[#3B82F6] to-[#9333EA]">
            <Image src="/img/remove.png" width={750} height={500} layout="fill" objectFit="cover" />
          </div>
        ...
        <div className="flex flex-col pl-24 pt-24 bg-sky-900 font-sans text-white w-full pr-16 lg:h-full h-screen">
          ...
          <div className="flex flex-col xl:hidden mb-16">
            <div id="ppbox" className="mx-auto -mt-26 rounded-full bg-gradient-to-r from-[#6EE7B7] via-[#3B82F6] to-[#9333EA]">
              <Image src="/img/remove.png" width={650} height={500} layout="fill" objectFit="cover" />
            </div>
          ...
          <div className="grid xl:grid-cols-2 justify-evenly lg:flex-col">
            ...
            <div className="flex flex-col justify-center mt-16 mx-16 ">
              ...
              <div id="inter" className="flex flex-col justify-center my-5 ">
                ...
                <p className="text-black mx-auto  my-5">
